...
Answer both of these questions (baseline ~5 sentences) here in text.
 ...
 In my opinion an important part of code reviews is the potential for improvement. I am two different people when I am coding and when I am reviewing code. When I code I think quickly and tend to rush, typically because of a time limit. However when I can take my time to read through and review my code I always think of a way to make it more efficient, easier to read, etc..

  Containers would allow you to run things in an isolated container. This means that you can run multiple applicatons, servers, etc. on one machine without them interferring with one another. Due to a containers isolative nature it makes it a lot easier to maintain, test, and deploy applications with similar functions in a manner that doesn't break compatability with any other application.
